...
public:
    ...
    void SysInit();
    void SysWarpMouse(lol::ivec2 pos);
    ...
    void SetMouseShape(image *im, lol::ivec2 center)
    {
        m_sprite->SetVisual(im, 1);
        m_center = center;
    }
    void SetMousePos(lol::ivec2 pos)
    {
        m_pos = lol::ivec2(Min(Max(pos.x, 0), m_screen->Size().x - 1),
